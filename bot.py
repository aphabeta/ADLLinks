...
async def start_cmd(message: types.Message):
    ...
    await message.answer(
        "🎭 <b>Welcome to ADrama Lovers Links Bot</b>\n\n"
...
async def find_cmd(message: types.Message):
    ...
    await message.answer(
        f"🔍 <b>Search results for:</b> <code>{keyword}</code>",
        reply_markup=kb,
    )
...
async def add_category_cmd(message: types.Message):
    ...
    await message.answer(f"✅ Category added: <b>{name}</b>")
...
async def edit_link_cmd(message: types.Message):
    ...
    await message.answer(f"🔗 Link updated for <b>{drama}</b>")
...
async def del_button_cmd(message: types.Message):
    ...
    await message.answer(f"🗑️ Drama deleted: <b>{text}</b>")
...
async def photo_handler(message: types.Message):
    ...
    await message.answer(f"🖼️ Thumbnail saved for <b>{drama}</b>")
